...
```{r read data 03}
single.cohort = read.csv('data/single-cohort.csv')

multiple.cohort = read.csv('data/multiple-cohort.csv')

accelerated = read.csv('data/accelerated.csv')
```
